...
function App({ tooltipOpen, tooltipData, tooltipLeft, tooltipTop, showTooltip, hideTooltip }) {
  const [xDomain, setXDomain] = useState([new Date('2019-01-01'), new Date('2024-01-01')]);
  ...
  return (
    <div className="App" onWheel={onWheel}>
        <div className='body'>
            <h1><a href='#'>Filter</a>  || <a href="#">Contribute</a> || <a href='#'>Evaluate</a></h1>
        </div>
